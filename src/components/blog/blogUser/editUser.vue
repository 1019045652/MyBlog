<template>
  <div style=" width:100%;background:rgb(238, 238, 238);padding-top:50px;">
    <div v-show="isRegist" style="background:rgb(238, 238, 238);padding:20px 100px 100px 100px;">
      <div style="text-align:center;font-size:30px; margin-bottom:40px;">编辑信息</div>
      <a-form :form="form">
        ...
        <a-form-item :labelCol="formItemLayout.labelCol">
          <a-button style="margin-left:420px;width:100px;">取消</a-button>
...
export default {
  ...
  mounted(){
     ...
     api
        ...
        .then(res => {
          var userMessage = res.data.result;
          this.form.setFieldsValue({
              userName: userMessage.userName,
              userWriteName: userMessage.userWriteName,
              });
              this.imageUrl = userMessage.userImage;
              this.userSex = userMessage.userSex;
              this.userPhone = userMessage.userPhone;
              this.userAddress = userMessage.userAddress;
        });
  },
  methods: {
    // 校验两次密码的输入是否一致
